...
$sql="SELECT * FROM village_anthem WHERE id=1";
          ...
          <!-- Page Content -->
          	...
          	<div class="main-content">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                      <div class="card-body">
                   <form method="post" action="events/va.php">
            <!-- Form -->
            <div class="form">
              <label>Preview&nbsp(151 characters)</label>
               <textarea name="preview" class="form-control" rows="3" cols="120"><?php echo $rows['preview']; ?></textarea>
               <label>Content</label>
