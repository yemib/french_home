...
$img = "";
        if(isset($_POST['post'])){
            ...
            $update2 = mysqli_query($db, "UPDATE directorate SET name = '$text' where id = '1' ");
            //die(mysqli_error($db));
           if($update2){
        ...
        $result = mysqli_query($db, "SELECT * FROM directorate where id = 1");
        $fetch = mysqli_fetch_assoc($result);

if(isset($_POST['delete'])){
  $text = $_POST['text'];
      $querydel = mysqli_query($db, "UPDATE directorate SET name = NULL WHERE id = 1");
