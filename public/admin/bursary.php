...
$img = "";
        if(isset($_POST['post'])){
            ...
            $update2 = mysqli_query($db, "UPDATE bursary SET name = '$text' where id = '1' ");
            //die(mysqli_error($db));
           if($update2){
        ...
        $result = mysqli_query($db, "SELECT * FROM bursary where id = 1");
...
if(isset($_POST['delete'])){
    $text = $_POST['text'];
      $querydel = mysqli_query($db, "UPDATE bursary SET name = NULL WHERE id = 1");
      //die(mysqli_error($db));
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Box Head -->
          <div class="box-head">
            <h2 class="left">Bursary Staffs</h2>
