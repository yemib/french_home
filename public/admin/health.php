...
$img = "";
        ...
        $update2 = mysqli_query($db, "UPDATE health SET name = '$text' where id = '1' ");
            //die(mysqli_error($db));
           if($update2){
        ...
        $result = mysqli_query($db, "SELECT * FROM health where id = 1");
        $fetch = mysqli_fetch_assoc($result);

if(isset($_POST['delete'])){
    $text = $_POST['text'];
    $querydel = mysqli_query($db, "DELETE FROM health WHERE id = 1");
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Box Head -->
          <div class="box-head">
            <h2 class="left">Health Services Staffs</h2>
