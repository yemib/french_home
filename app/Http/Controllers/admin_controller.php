...
use Tutorialspoint\add_category;
use Tutorialspoint\add_product;

use Tutorialspoint\slider;
use Tutorialspoint\page_content;
use Tutorialspoint\pickup;

use Tutorialspoint\order_list;
use Tutorialspoint\user_admin;
use Tutorialspoint\vendor_list;

use Tutorialspoint\client;
use Tutorialspoint\saved_item;
use Tutorialspoint\cart_list;
use Tutorialspoint\logo;

use Tutorialspoint\contact_detail;
use Tutorialspoint\vendorper;
use Tutorialspoint\now_address;
use Tutorialspoint\icons;

use Tutorialspoint\banner2;
use Tutorialspoint\banner1;
use Tutorialspoint\font;
use Tutorialspoint\account_detail;
use Validator;
