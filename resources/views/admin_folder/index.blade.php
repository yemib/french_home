    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="/managements">Staff</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-3  form_container">
          <div class="list-group">
            ...
            <a href="{{route('admin.journals.index')}}" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Journals </a>
            <a href="{{route('admin.sections.index')}}" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Sections </a>
            <a href="{{route('admin.menus.index')}}" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Menu </a>
            ...
            <a href="/managements" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Staff </a>
