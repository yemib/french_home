...
?>
 ...
 <div class="flat-slider style1"   style="position: relative; background: rgba(107,187,253,1.00)"> 
   <!-- SLIDER --> 
   ...
   <div class="rev_slider_wrapper fullwidthbanner-container"> 
    <div id="rev-slider3" class="rev_slider fullwidthabanner"> 
     ...
     <?php   foreach($select_slide as $select_slide){   ?>
      ...
      <div  style="position: absolute ; width: 100%; ">  <marquee   style="color: black"> <p >   {!!   $moving_news->body !!}  </p>  </marquee>  </div>
